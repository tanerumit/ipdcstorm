...
#'   `make_climate_cfg()`. Use `make_climate_cfg(scenario = "stationary")`
#'   for a baseline climate run with `delta_sst = 0`. When `NULL`, the climate
#'   module is disabled entirely and the run uses `delta_sst = 0`,
#'   `beta_sst = 0`, `gamma = 0`, with storm perturbation disabled.
