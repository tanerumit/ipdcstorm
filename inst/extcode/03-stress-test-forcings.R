...
# and damage columns across all simulation years. Omitting `seed` here causes
# the function to inherit hazard_out$run_metadata$seed automatically, ensuring
# full end-to-end reproducibility from a single seed value.
