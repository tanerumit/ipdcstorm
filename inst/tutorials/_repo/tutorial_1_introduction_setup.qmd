...
| `severity` | `TS` (tropical storm, 34–63 kt) or `HUR64plus` (hurricane, ≥64 kt) |
...
| `n_HUR64plus` | Hurricane-strength events (≥64 kt) |
...
| `severity` | Classification based on site-level wind: `TS` or `HUR64plus` |
